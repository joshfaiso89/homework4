...
function scoreRender(){
    ...
    let img = (scorePerCent >= 80) ? "assets/images/thumbsup.png" :
              (scorePerCent >= 60) ? "assets/images/halfthumb.png" :
              (scorePerCent >= 40) ? "assets/images/thumbsdown.png" :
              (scorePerCent >= 20) ? "assets/images/thumbsdown.png" :
